...
Before installing FMP, the following must be installed on your Linux system:
...
The user is asked what account they would like to remove, and the corresponding vault is decrypted. All files relating to the vault are deleted.
...
Asks user what vault name to change and what they want to change it to. Decrypts vault, changes its name then re-encrypts it. Old vault files are removed.
